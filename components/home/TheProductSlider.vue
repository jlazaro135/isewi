<template>
    <TheSectionContainer>
        ...
        <div
            ...
            :key="id"
            class="first:ms-auto last:me-auto border border-neutral-200 shrink-0 rounded-md hover:shadow-lg w-[50%] lg:w-[20%]"
        >
            <div class="relative">
                <SfLink href="#" class="block">
                    ...
                    :src="img.src"
                    :alt="img.alt"
                    class="block object-cover h-auto rounded-md aspect-square w-[100%] h-[100%]"
                    width="146"
                    height="146"
                    />
                </SfLink>
